...
class Admin extends BaseController
{
    ...
    public function berita(){
		...
		if(!$key){
			$data = $this->postModel->where("kategori","berita");
		}else{
			$data = $this->postModel->where("kategori","berita")->groupStart()->like("judul",$key)->orLike("isi",$key)->groupEnd();
		}
    ...
    public function pengumuman(){
		$key = $this->request->getVar("key");
		if(!$key){
			$data = $this->postModel->where("kategori","pengumuman");
		}else{
			$data = $this->postModel->where("kategori","pengumuman")->groupStart()->like("judul",$key)->orLike("isi",$key)->groupEnd();
		}
    ...
    public function pengajian(){
		$key = $this->request->getVar("key");
		if(!$key){
			$data = $this->postModel->where("kategori","pengajian");
		}else{
			$data = $this->postModel->where("kategori","pengajian")->groupStart()->like("judul",$key)->orLike("isi",$key)->groupEnd();
		}
    ...
    public function kegiatan(){
		$key = $this->request->getVar("key");
		if(!$key){
			$data = $this->postModel->where("kategori","kegiatan");
		}else{
			$data = $this->postModel->where("kategori","kegiatan")->groupStart()->like("judul",$key)->orLike("isi",$key)->groupEnd();
		}
    ...
    public function tambahPostingan(){
		...
		return view('admin/tambahpostingan',$data);
	}
	...
	public function insertPostingan(){
		...
		if(!$this->validate([
			...
			return redirect()->to("/admin/tambahpostingan")->withInput();
		};
		...
		return redirect()->to("/admin/".$request->getVar("kategori"));
	}
	...
	public function editPost($slug){
		...
		return view('admin/editpostingan',$data);
	}
	...
	public function updatePost($id){
		...
		if(!$this->validate([
			...
			return redirect()->to("/admin/editpost/".$request->getVar("slug"))->withInput();
		};
