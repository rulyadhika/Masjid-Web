...
class User extends BaseController
{
    ...
    public function index()
    {
        ...
        $data = [
            'title' => 'Admin - User Management | Masjid As-Salam',
            'menuTitle' => "Kelola User",
    ...
    public function update()
    {
        ...
        if ($old_role == 'dev' && (in_groups('dev') == false)) {
            ...
            session()->setFlashdata("pesan", "Data User Gagal Diubah, Anda tidak memiliki ijin untuk merubah data user tersebut!");
