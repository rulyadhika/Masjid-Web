    ...
    <div class="col">
        <div class="card card-success card-outline">
            <div class="d-flex justify-content-between py-2 px-3 border-bottom">
                <h5 class="my-auto">Tambah Postingan</h5>
            </div>
            <div class="card-body">
                <form action="<?= base_url("admin/postingan/insertPostingan") ?>" method="post" enctype="multipart/form-data">
                    <?= csrf_field(); ?>
                    <div class="row mb-2">
                        <div class="col-md-9">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control <?= $validation->hasError("judul") ? 'is-invalid' : '' ?>" id="judul" name="judul" placeholder="Masukan judul" value="<?= old("judul") ?>" required>
                                    <div id="validationServer03Feedback" class="invalid-feedback">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="penulis" value="<?= user()->username; ?>" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                        ...
                        <div class="col-md-3">
                            ...
                            <img src="<?= base_url("/asset/images/thumbnails/default.jpg") ?>" class="img-preview img-thumbnail" alt="">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="editor" class=" mr-2">Isi Text</label><span class="text-muted">(Judul tidak perlu
                            dituliskan
                            kembali)</span>
                        <textarea name="content" id="editor" placeholder="Masukan isi text"><?= old("content"); ?></textarea>
